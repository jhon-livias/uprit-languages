      ...
      <div className="mx-auto w-[90%] max-w-[1440px] lg:w-[70%]">
        ...
        <div className="relative">
          <div
            ref={viewportRef}
            className={clsx(
              "relative h-[300px] overflow-hidden select-none sm:h-[280px] md:h-[320px] lg:h-[300px]",
          ...
          <div className="mt-4 flex items-center justify-center gap-4 md:mt-0 md:contents">
            <button
              ...
              className="grid size-10 cursor-pointer place-items-center rounded-full bg-dark-nav text-white shadow-md transition-opacity duration-200 hover:bg-dark-surface focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cta md:absolute md:top-[58%] md:left-0 md:z-10 md:size-11 md:-translate-x-1/2 md:-translate-y-1/2"
            >
            ...
            <button
              ...
              onClick={goToNext}
              className="grid size-10 cursor-pointer place-items-center rounded-full bg-dark-nav text-white shadow-md transition-opacity duration-200 hover:bg-dark-surface focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cta md:absolute md:top-[58%] md:right-0 md:z-10 md:size-11 md:translate-x-1/2 md:-translate-y-1/2"
            >
        ...
        <div className="mt-5 flex items-center justify-center gap-2.5 md:mt-8">
