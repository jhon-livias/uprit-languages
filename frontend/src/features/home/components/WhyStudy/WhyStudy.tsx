      ...
      <div className="mx-auto w-[90%] max-w-[1440px] lg:w-[70%]">
        ...
        <div className="relative">
          <div
            ref={viewportRef}
            className={clsx(
              "relative h-[280px] touch-pan-x overflow-hidden select-none md:h-[300px]",
          ...
          <button
            ...
            className="absolute top-[58%] left-0 z-10 grid size-11 -translate-x-1/2 -translate-y-1/2 cursor-pointer place-items-center rounded-full bg-dark-nav text-white shadow-md transition-opacity duration-200 hover:bg-dark-surface focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cta"
          >
          ...
          <button
            ...
            onClick={goToNext}
            className="absolute top-[58%] right-0 z-10 grid size-11 translate-x-1/2 -translate-y-1/2 cursor-pointer place-items-center rounded-full bg-dark-nav text-white shadow-md transition-opacity duration-200 hover:bg-dark-surface focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cta"
          >
            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  isActive ? "w-8 bg-info" : "w-2.5 bg-primary",
                )}
              />
            )
          })}
